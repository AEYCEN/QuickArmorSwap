...
Before using QuickArmorSwap, you need to prepare a few things inside ARK. These steps apply similarly to both ASE and ASA.
...
<img src="../img/screenshot/ase-windowed-mode.png" style="width: 100%" alt="SCREENSHOT: ARK display settings showing windowed/windowed fullscreen option">
...
1. Open ARK
2. Navigate to the setting **"Options → Advanced Settings"**
3. Check **"Disable Menu Transitions"**
4. Click **Apply** and **Save**

<img src="../img/screenshot/ase-disable-transitions.png" style="width: 100%" alt="SCREENSHOT: ARK advanced settings with 'Disable Menu Transitions' checked">
...
<img src="../img/screenshot/ase-inventory-folder.png" style="width: 100%" alt="SCREENSHOT: ARK inventory with folder view enabled and an 'Armor' folder visible">
...
<img src="../img/screenshot/ase-inventory-filled-folder.png" style="width: 100%" alt="SCREENSHOT: Inside the armor folder showing multiple complete armor sets">
