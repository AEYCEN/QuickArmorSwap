...
<img src="../img/screenshot/asa-windowed-mode.png" style="width: 100%" alt="SCREENSHOT: Ark display settings showing windowed/windowed fullscreen option">
...
<img src="../img/screenshot/asa-disable-transitions.png" style="width: 100%" alt="SCREENSHOT: Ark advanced settings with 'Disable Menu Transitions' checked">
...
<img src="../img/screenshot/asa-inventory-filled-folder.png" style="width: 100%" alt="SCREENSHOT: Inside the armor folder showing multiple complete armor sets">
